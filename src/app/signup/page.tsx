            ...
            <div className="w-full space-y-5 rounded-xl p-5 dark:border-white/10 sm:max-w-[350px] sm:border">
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-5 ">
                        ...
                        />
                        {error && (
                            <div className="bg-gradient-to-[40deg] flex items-center gap-3 rounded-md bg-red-100 px-3 py-3 text-sm font-medium text-red-500">
                ...
                <Link href="/login" className="mx-auto block w-fit text-sm font-medium text-blue-500 hover:underline">
