    ...
    return (
        <div className="overflow-hidden pl-2 pt-0 sm:pl-5 sm:pt-5">
            <div className="flex h-full flex-col gap-3 overflow-hidden pb-5">
                ...
                <Form />
                <EditForm
                    editFormPlaylistId={editFormPlaylistId}
                    ...
                    {playlists ? (
                        <>
                            {!playlists.length ? (
                                ...
                                <div className="grid grid-cols-2 gap-4 overflow-auto xs:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-7">
                                    {playlists?.map((e, i) => (
                                        <PlaylistCard
                                            setEditFormPlaylistId={setEditFormPlaylistId}
                                            setEditFormName={setEditFormName}
                                            setIsEditFormOpen={setIsEditFormOpen}
                                            key={i}
                                            playlist={e}
