        ...
        <div className="aspect-square h-full shrink-0 select-none overflow-hidden rounded-full bg-primary text-white">
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    <div className="flex h-full w-full cursor-pointer items-center justify-center">{user.name?.slice(0, 1)}</div>
                </DropdownMenuTrigger>
                <DropdownMenuContent className="mr-2">
                    ...
                    <DropdownMenuItem onClick={() => setIsDialogOpen(true)} className=" text-red-500 hover:!text-red-500 dark:text-red-400 dark:hover:!text-red-400">
                        Delete Account
                    </DropdownMenuItem>
                </DropdownMenuContent>
            </DropdownMenu>
            <Dialog open={isDialogOpen} onOpenChange={(e) => setIsDialogOpen(e)}>
                <DialogContent>
                    ...
                    <div>
                        <Input value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Your Password" className="dark:text-white/90" />
                    ...
                    <DialogFooter className="gap-2 sm:justify-start">
                        ...
                        <Button loading={loading} disabled={loading} variant="destructive" className="w-full hover:!bg-red-600 dark:bg-red-500" onClick={handleDelete}>
                            Delete
                        </Button>
                    </DialogFooter>
                </DialogContent>
